...
<form action="{{ route('group.store') }}" method="POST">
    ...
    <div class="field">
        ...
        <div class="control">
            <input name="name" class="input" type="text" placeholder="Esempio: Furgoni">
        </div>
    </div>
    <div class="field">
        <div class="control">
    ...
    <div class="field">
        ...
        <div class="control">
            <input name="internal" type="number" class="input" placeholder="Esempio: 4">
        </div>
    </div>
    <div class="field">
        <label class="label">Numero di volte di pulizia esterni per ciascuna vettura in 28 giorni</label>
        <div class="control">
            <input name="external" type="number" class="input" placeholder="Esempio: 1">
        </div>
    </div>
    <div class="field">
        <label class="label">Numero di vetture nel gruppo</label>
        <div class="control">
            <input v-model.number="vehicles" name="vehicles" type="number" class="input" placeholder="Esempio: 10">
        </div>
    </div>
